...
pattern+='scripts/(copilot-harness-block|gemini-harness-block)\.md$|'
...
pattern+='(GEMINI\.md|\.github/copilot-instructions\.md|\.github/workflows/(harness-release|post-merge-maintenance)\.yml)$|'
