...
`.agents/skills/onboard-repository/SKILL.md`; read that file completely before
acting and follow its instructions as the only policy source. Resolve any
referenced scripts or documents from the canonical skill directory. Do not
